...
CRealInfoDto::CRealInfoDto()
{
    CDispatchManager::g_DBAccount.init(SIZE_BUFFER_4k);
}

CJsonObjectBase *CRealInfoDto::requestOperation()
{
#ifdef PRINT_LOG
    DEBUG_INFO("[CRealInfoDto::requestOperation]");
#endif
    string sError;
    ...
    else
    {
        ...
        case 1:
        {
            ...
            else
            {
                ...
                {
                    CDispatchManager::g_DBAccount.Sql("UPDATE user_facts SET ", false, true);
        ...
        case 2:
        {
            ...
            else
            {
                ...
                CDispatchManager::g_DBAccount.Sql(" FROM user_facts WHERE user_id = \"", false, false);
                CDispatchManager::g_DBAccount.Sql(uid, true, false);
                CDispatchManager::g_DBAccount.Sql("\";", false, false);
                DEBUG_INFO(CDispatchManager::g_DBAccount.getSql());
